...
def test_security_headers_root(client):
    ...
    assert response.headers.get('Content-Security-Policy') == "default-src 'none'; object-src 'none'; frame-ancestors 'none'; base-uri 'none'; form-action 'none'; upgrade-insecure-requests"
